...
class PolicyValueNet:
    ...
    def __init__(self, board_width, board_height, actions, model_file=None):
        self.board_width = board_width
        self.board_height = board_height
        self.actions = actions
        self.l2_const = 1e-4  # coef of l2 penalty
        self.policy_net = self.value_net = self.model = None
    ...
    def create_policy_value_net(self):
        ...
        self.policy_net = Dense(len(self.actions), activation="softmax",
    ...
    def policy_value_fn(self, reshaped_state):
        """
        input: board
        output: a list of (action, probability) tuples for each available action and the score of the board state
        """
        legal_positions = self.actions
        act_probs, value = self.policy_value(reshaped_state)
